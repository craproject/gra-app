    ...
    <div class="row no-gutters">
        <div class="col-12">
            ...
            <v-select
                ...
                :error-messages="citizenshipValidationMessage"
                @change="
                    v$.citizenshipType.$touch;
                    updateFieldsRelatedToCitizenType();
                "
                @blur="v$.citizenshipType.$touch"
            >
                <template v-slot:label>
                    <span class="required">Citizenship</span>
                </template>
            </v-select>
            ...
            >
                <template v-slot:label>
                    <span
                        class="required"
                        v-if="
                            getOptionText(citizenshipTypeOptions, citizenshipType) ===
                                'Singapore Citizen' ||
                            getOptionText(citizenshipTypeOptions, citizenshipType) ===
                                'Permanent Resident'
                        "
            ...
            <!-- Have other citizenshipType -->
            <v-radio-group v-model="haveOtherCitizenship" >
                <template v-slot:label>
                    <span class="required">
                        Please declare if you are currently holding a Citizenship / Permanent
                        Residence of another country:
                    </span>
                </template>

                <v-radio :class="{'required': isForeigner, '':!isForeigner}" value="Yes" label="Check this box to add fields"></v-radio>
                <v-radio value="No" label="Not Applicable" v-if="!isForeigner"></v-radio>

                <!-- Validation -->
                <small v-if="haveOtherCitizenship === ''">
                    <span class="red--text">{{ haveOtherCitizenshipValidationMessage }}</span>
                </small>
            </v-radio-group>
        </div>
